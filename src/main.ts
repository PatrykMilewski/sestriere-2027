...
function shell(): string {
  ...
  ${transportSection()}
  <section class="section" id="noclegi">${heading('02 / BAZA W GÓRACH', 'Klucze do dobrego tygodnia.', 'Cały pobyt, nie cena za noc. Sprawdź układ łóżek: sofa w Casa Rossa, łóżko piętrowe w Nube.')}<div id="stays"></div><p class="footnote">Oferty sprawdzone 19–20.09.2026; dostępność może się zmienić. Odległości według opisów ofert, nie pomiaru zimowej drogi pieszej. Nic nie zostało zarezerwowane.</p></section>
...
function alternativeFlightMarkup(): string {
  return `<div class="transport-note"><b>Tańszy Buzz — cena niepełna</b><p>Skyscanner pokazał dla pary bilety A/R od 1150 zł (16–23 sty) i 627 zł (23–30 sty), bez wymaganej walizki i snowboardów. Godziny: 14:05–16:20 oraz 16:45–19:00. Pełny koszt bagaży i dojazd po późniejszym lądowaniu wymagają potwierdzenia. Dlatego rekomendacja terminu powyżej dotyczy porównania Wizz, nie gwarancji najtańszego wariantu wszystkich linii. ${external(flightLink('late', party), 'Sprawdź Buzz na drugi termin')}</p></div>`;
}
