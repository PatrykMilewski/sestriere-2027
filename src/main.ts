...
function shell(): string {
  ...
  ${transportSection()}
  <section class="section" id="noclegi">${heading('02 / BAZA W GÓRACH', 'Klucze do dobrego tygodnia.', 'Cena na osobę za 7 nocy, przy podanej liczbie osób w lokalu. Sprawdź układ łóżek: sofa w Casa Rossa, łóżko piętrowe w Nube.')}<div id="stays"></div><p class="footnote">Oferty sprawdzone 19–20.09.2026; dostępność może się zmienić. Odległości według opisów ofert, nie pomiaru zimowej drogi pieszej. Nic nie zostało zarezerwowane.</p></section>
